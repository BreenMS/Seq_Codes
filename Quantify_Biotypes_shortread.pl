#!/usr/bin/perl -w
use strict;
#THIS CODE QUANTIFIES DETECTED BIO-TYPES IN SHORT-READ DATA. DATA MUST BE FORMATTED AS MATRIX WITH FIRST THREE COLUMNS INDICATING: GENEID, BIOTYPE, PROBEOVERLAP, FOLLOWED BY EXPRESSION DATA.
